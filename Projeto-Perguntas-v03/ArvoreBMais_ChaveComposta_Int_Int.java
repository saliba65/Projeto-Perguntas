...
public class ArvoreBMais_ChaveComposta_Int_Int {
    ...
    private class Pagina {
        ...
        public int ordem; // Número máximo de filhos que uma página pode ter
        ...
        public int n; // Número de elementos presentes na página
        public int[] chaves1; // Chave 1 (principal)
        public int[] chaves2; // Chave 2 (subordinada)
        public long proxima; // Próxima folha, quando a página for uma folha
        public long[] filhos; // Vetor de ponteiros para os filhos
        public int TAMANHO_REGISTRO; // Os elementos são de tamanho fixo
